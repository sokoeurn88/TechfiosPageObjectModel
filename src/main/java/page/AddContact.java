...
public class AddContact {
	...
	@FindBy(how = How.ID, using = "company") WebElement name;
	...
	@FindBy(how = How.ID, using = "submit") WebElement submitbutton;
	
	public void fillingUpAddressForm(String Fullname,String Name, String Email,String Phone, String Address,String City, String State, String Zip) {
